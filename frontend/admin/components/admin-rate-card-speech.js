...
export class AdminRateCardSpeech extends LitElement {
        ...
        <div style="display:grid; gap: var(--space-3);">
          ...
          <label
            ...
            <input
              ...
              inputmode="decimal"
              style="width:100%"
              .value=${this._form.usd_per_million_chars}
  ...
  _cols() {
    return [
      ...
      {
        field: 'usd_per_million_chars',
        header: '$/M chars',
        render: (r) => Number(r.usd_per_million_chars).toFixed(4),
      },
  ...
  _emptyForm() {
    return { model_or_pattern: '', is_pattern: false, usd_per_million_chars: '', sort_order: 100 };
  }
  _openAdd() {
    this._form = this._emptyForm();
    this._err = '';
  ...
  _submitAdd = async () => {
    ...
    if (!f.usd_per_million_chars.toString().trim()) {
    ...
    try {
      const body = {
        ...
        usd_per_million_chars: f.usd_per_million_chars,
      };
...
if (!customElements.get('admin-rate-card-speech'))
  customElements.define('admin-rate-card-speech', AdminRateCardSpeech);
