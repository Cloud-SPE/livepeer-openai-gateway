...
export class AdminRateCardImages extends LitElement {
  ...
  render() {
    ...
    return html`
        ...
        <div style="display:grid; gap: var(--space-3);">
          ...
          <div style="display:grid; grid-template-columns: 1fr 1fr; gap: var(--space-3);">
            <label
              >Size
              <select
                .value=${this._form.size}
                @change=${(e) => this._set('size', e.target.value)}
                style="width:100%"
              >
            ...
            <label
              >Quality
              <select
                .value=${this._form.quality}
                @change=${(e) => this._set('quality', e.target.value)}
                style="width:100%"
              >
          ...
          <label
            ...
            <input
              ...
              inputmode="decimal"
              style="width:100%"
              .value=${this._form.usd_per_image}
      ...
      <bridge-confirm-dialog
        ...
        body="Customers requesting this (model, size, quality) will get model_not_found until you re-add it."
  ...
  _cols() {
    return [
      ...
      { field: 'quality', header: 'Quality', render: (r) => r.quality },
      {
        field: 'usd_per_image',
        header: '$/image',
        render: (r) => Number(r.usd_per_image).toFixed(4),
      },
  ...
  _submitAdd = async () => {
    ...
    if (!f.usd_per_image.toString().trim()) {
...
if (!customElements.get('admin-rate-card-images'))
  customElements.define('admin-rate-card-images', AdminRateCardImages);
