...
import { ImagesGenerationRequestSchema } from '@cloudspe/livepeer-openai-gateway-core/types/images.js';
...
export function registerImagesGenerationsRoute(app: FastifyInstance, deps: ImagesDeps): void {
  ...
  app.post('/v1/images/generations', { preHandler }, (req, reply) =>
    handleImageGeneration(req, reply, deps),
  );
}
