...
| Quote age table empty                                             | This stack no longer runs bridge-side quote refresh. If the panel still exists, update the dashboard to a resolver/route-health panel or remove the legacy widget.                                                                                |
