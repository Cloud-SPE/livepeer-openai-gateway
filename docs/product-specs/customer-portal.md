...
This spec is the canonical UX contract — the page-by-page behavior the implementation must match. For *how* the SPA is built (Lit + RxJS + modern CSS, light DOM, hash routing, npm workspaces), see [`ui-architecture.md`](../design-docs/ui-architecture.md).
