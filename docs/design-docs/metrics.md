...
- **Legacy unprefixed metrics from [`0011-local-tokenizer-metric.md`](../exec-plans/completed/0011-local-tokenizer-metric.md)**: Phase 1 emits both `tokens_drift_percent` (deprecated) and `livepeer_bridge_token_drift_percent` for one release window. Phase 2 deletes the unprefixed name.
